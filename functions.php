...
function single_rapater_meta_boxes() {
	add_meta_box( 'single-repeter-data', 'Single Rapeter', 'single_repeatable_meta_box_callback', 'Slider', 'normal', 'default');
}
		...
		<tbody>
			...
			if ( $single_repeter_group ) :
				foreach ( $single_repeter_group as $field ) {
					?>
					<tr>
						<td><input type="file"  style="width:98%;" name="image[]" src="<?php if($field['image'] != '') echo esc_attr( $field['image'] ); ?>" placeholder="Image" /></td>
						<td><input type="text"  style="width:98%;" name="title[]" value="<?php if($field['title'] != '') echo esc_attr( $field['title'] ); ?>" placeholder="Title" /></td>
						<td><textarea style="width:98%;" name="tdesc[]" value="<?php if ($field['tdesc'] != '') echo esc_attr( $field['tdesc'] ); ?>" placeholder="description"><?php if ($field['tdesc'] != '') echo esc_attr( $field['tdesc'] ); ?> </textarea>
							</td>
						<td>
						<label><input type="radio" value="yes" name="demo" checked="checked" />Yes</label>
<label><input type="radio" value="no" name="demo" />No</label></td>
					</tr>
					<?php
				}
			else :
				?>
				<tr>
					<td><input type="file"   style="width:98%;" name="image[]" placeholder="Image"/></td>
					<td><input type="text"   style="width:98%;" name="title[]" placeholder="Title"/></td>
					<td>
						<textarea style="width:98%;" name="tdesc[]" value="<?php if ($field['tdesc'] != '') echo esc_attr( $field['tdesc'] ); ?>" placeholder="description"> <?php if ($field['tdesc'] != '') echo esc_attr( $field['tdesc'] ); ?></textarea></td>
					<td>
					<label><input type="radio" value="yes" name="demo" checked="checked" />Yes</label>
<label><input type="radio" value="no" name="demo" />No</label></td>
				</tr>
			...
			<tr class="empty-row custom-repeter-text" style="display: none">
					<td><input type="file" style="width:98%;" name="image[]" placeholder="Image"/></td>
				<td><input type="text" style="width:98%;" name="title[]" placeholder="Title"/></td>
				<td><textarea style="width:98%;" name="tdesc[]" value="<?php if ($field['tdesc'] != '') echo esc_attr( $field['tdesc'] ); ?>" placeholder="description"><?php if ($field['tdesc'] != '') echo esc_attr( $field['tdesc'] ); ?> </textarea></td>
				<td>
				<label><input type="radio" value="yes" name="demo" checked="checked" />Yes</label>
<label><input type="radio" value="no" name="demo" />No</label></td>
			</tr>
